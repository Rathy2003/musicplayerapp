                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return customTileList(
                        ...
                        isActive: controller.currentSongInd == index ? true : false,
                    ...
                    Row(
                      children: [
                        Container(
                            ...
                            child: controller.currentSong==""?Image.asset("assets/images/disc.png") : Image.network(controller.currentCover,fit: BoxFit.cover,)
                        ),
                        ...
                        SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(controller.currentTitle,style:
                              const TextStyle(
                                  fontSize: 20,
                        ...
                        IconButton(
                            ...
                            icon:Icon(controller.isPlay?Icons.pause:controller.icon,size: 50,)
                        )
                      ],
                    )
                  ],
