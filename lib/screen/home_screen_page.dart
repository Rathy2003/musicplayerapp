                            ...
                            children: [
                              Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      color: Colors.grey.withOpacity(0.5)),
                                  child: controller.currentSongInd < 0
                                      ? Image.asset("assets/images/disc.png")
                                      : Image.network(
                                          controller.songsData[controller.currentSongInd]["cover"],
                                          fit: BoxFit.cover,
                                        )),
                              const SizedBox(
                                width: 10,
                              ...
                              SizedBox(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      controller.currentSongInd >= 0 ? controller.songsData[controller.currentSongInd]["title"] : "",
                                    ...
                                    Text(
                                      controller.currentSongInd >= 0 ? controller.songsData[controller.currentSongInd]["artist"] : "",
                                      style: const TextStyle(
                                          fontSize: 17,
                                          fontFamily: "NotoSans"
                                      ),
